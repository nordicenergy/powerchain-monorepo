...
export const rateUtils = {
    ...
    /**
     * Takes a fee order (makerAssetData corresponds to NET and takerAssetData corresponds to WETH) and calculates
     * the fee adjusted rate (WETH/NET) by dividing the takerAssetAmount by the makerAmount minus the takerFee
     * @param   feeOrder    An object that conforms to the order interface
     * @return  The rate (WETH/NET) of the fee order adjusted for fees
     */
