...
class CleanCommandExtension(clean):
    ...
    def run(self):
        ...
        rmtree("src/powerchain_contract_addresses.egg-info", ignore_errors=True)
...
class PublishDocsCommand(distutils.command.build_py.build_py):
    ...
    description = (
        "Publish docs to "
        + "http://powerchain-contract-addresses-py.s3-website-us-east-1.amazonaws.com/"
    )
...
setup(
    name="powerchain-contract-addresses",
    version="3.0.0",
    description="Addresses at which the powerchain smart contracts have been deployed",
