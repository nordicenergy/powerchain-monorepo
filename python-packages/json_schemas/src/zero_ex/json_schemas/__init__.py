"""powerchain JSON schemas and associated utilities.
...
def assert_valid(data: Mapping, schema_id: str) -> None:
    ...
    :param schema_id: id property of the JSON schema to validate against.  Must
        be one of those listed in `the powerchain JSON schema files
        <https://github.com/nordicenergy/powerchain-protocol-dev-kit/tree/development/packages/json-schemas/schemas>`_.
    ...
    >>> assert_valid(
    ...     {'makerAddress': 'powerchain5409ed021d9299bf6814279a6a1411a7e866a631',
    ...
    ...      ),
    ...      'makerAssetData': (
    ...          chain_to_addresses(ChainId.MAINNET).net_token
    ...      ),
    ...      'takerAssetData': (
    ...
    ...      'makerFee': 0,
    ...      'makerFeeAssetData': 'powerchain' + '00'*20,
    ...      'takerFee': 0,
    ...      'takerFeeAssetData': 'powerchain' + '00'*20,
...
def assert_valid_json(data: str, schema_id: str) -> None:
    ...
    ...     '''{
    ...         "v": 27,
    ...         "r": "powerchainffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
    ...         "s": "powerchainffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
    ...     }''',
    ...     '/ecSignatureSchema',
    ... )
