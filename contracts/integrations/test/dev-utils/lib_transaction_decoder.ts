...
import {artifacts, LibTransactionDecoderContract} from '@powerchain/contracts-dev-utils';
...
const order = {
    makerAddress: 'powerchaine36ea790bc9d7ab70c55260c66d52b1eca985f84',
    takerAddress: 'powerchain0000000000000000000000000000000000000000',
    feeRecipientAddress: 'powerchain78dc5d2d739606d31509c31d654056a45185ecb6',
    senderAddress: 'powerchain6ecbe1db9ef729cbe972c83fb886247691fb6beb',
    ...
    makerAssetData: 'powerchainf47261b000000000000000000000000034d402f14d58e001d8efbe6585051bf9706aa064',
    takerAssetData: 'powerchainf47261b000000000000000000000000025b8fe1de9daf8ba351890744ff28cf7dfa8f5e3',
    makerFeeAssetData: 'powerchainf47261b000000000000000000000000034d402f14d58e001d8efbe6585051bf9706aa064',
    takerFeeAssetData: 'powerchainf47261b000000000000000000000000025b8fe1de9daf8ba351890744ff28cf7dfa8f5e3',
};
const takerAssetFillAmount = new BigNumber('100000000000000000000');
const signature =
    'powerchain1ce8e3c600d933423172b5021158a6be2e818613ff8e762d70ef490c752fd98a626a215f09f169668990414de75a53da221c294a3002f796d004827258b641876e03';
...
describe('LibTransactionDecoder', () => {
    ...
    before(async () => {
        ...
        libTxDecoder = await LibTransactionDecoderContract.deployFrompowerchainArtifactAsync(
